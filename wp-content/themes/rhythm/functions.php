...
function rhythm_scripts() {
	...
	/* CUSTOM STYLE */
	wp_register_style( 'custom-style', get_template_directory_uri() . '/css/custom_style.css',null, TS_THEME_VERSION);
	wp_register_style( 'custom-responsive-style', get_template_directory_uri() . '/css/custom_mq_style.css',null, TS_THEME_VERSION);
	...
	wp_enqueue_style( 'custom-responsive-style', get_stylesheet_uri() );
...
/**
	* Custom Post tidy_parse_string
	*/
	// add_action( 'init', 'product_series_post_type' );
	// function product_series_post_type() {
	// 	$labels = array(
	// 		'name'               => _x( 'Product Series', 'post type general name', 'your-plugin-textdomain' ),
	...
	// 	);
	//
	// 	register_post_type( 'Product Series', $args );
	// }



	add_action( 'init', 'product_set_post_type' );
	function product_set_post_type() {
		$labels = array(
			'name'               => _x( 'Product Set', 'post type general name', 'your-plugin-textdomain' ),
			'singular_name'      => _x( 'Product Set', 'post type singular name', 'your-plugin-textdomain' ),
			'menu_name'          => _x( 'Product Set', 'admin menu', 'your-plugin-textdomain' ),
			'name_admin_bar'     => _x( 'Product Set', 'add new on admin bar', 'your-plugin-textdomain' ),
			'add_new'            => _x( 'Add New Set', 'Product', 'your-plugin-textdomain' ),
			'add_new_item'       => __( 'Add New Product', 'your-plugin-textdomain' ),
			'new_item'           => __( 'New Product Set', 'your-plugin-textdomain' ),
			'edit_item'          => __( 'Edit Product Set', 'your-plugin-textdomain' ),
			'view_item'          => __( 'View Product Set', 'your-plugin-textdomain' ),
			'all_items'          => __( 'All Products Sets', 'your-plugin-textdomain' ),
			'search_items'       => __( 'Search Products Sets', 'your-plugin-textdomain' ),
			'parent_item_colon'  => __( 'Parent Product  Sets:', 'your-plugin-textdomain' ),
			'not_found'          => __( 'No Products Sets found.', 'your-plugin-textdomain' ),
			'not_found_in_trash' => __( 'No Products Sets found in Trash.', 'your-plugin-textdomain' )
		);
		...
		register_post_type( 'Product Set', $args );
	}

	add_action( 'init', 'ch_products_post_type' );
	function ch_products_post_type() {
	  $labels = array(
	    'name'               => _x( 'Customer Hub Products', 'post type general name', 'your-plugin-textdomain' ),
	    'singular_name'      => _x( 'Customer Hub Products', 'post type singular name', 'your-plugin-textdomain' ),
	    'menu_name'          => _x( 'Customer Hub Products', 'admin menu', 'your-plugin-textdomain' ),
	    'name_admin_bar'     => _x( 'Customer Hub Products', 'add new on admin bar', 'your-plugin-textdomain' ),
	    'add_new'            => _x( 'Add New Set', 'Product', 'your-plugin-textdomain' ),
	    'add_new_item'       => __( 'Add New Product', 'your-plugin-textdomain' ),
	    'new_item'           => __( 'New Customer Hub Products', 'your-plugin-textdomain' ),
	    'edit_item'          => __( 'Edit Customer Hub Products', 'your-plugin-textdomain' ),
	    'view_item'          => __( 'View Customer Hub Products', 'your-plugin-textdomain' ),
	    'all_items'          => __( 'All Customer Hub Products', 'your-plugin-textdomain' ),
	    'search_items'       => __( 'Search Customer Hub Products', 'your-plugin-textdomain' ),
	    'parent_item_colon'  => __( 'Parent Product Sets:', 'your-plugin-textdomain' ),
	    'not_found'          => __( 'No Customer Hub Products found.', 'your-plugin-textdomain' ),
	    'not_found_in_trash' => __( 'No Customer Hub Products found in Trash.', 'your-plugin-textdomain' )
	  );
	  ...
	  register_post_type( 'Customer Hub Products', $args );
	}
