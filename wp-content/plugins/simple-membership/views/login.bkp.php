        ...
        <div class="swpm-login-form-inner">
          <div class="row">
            <div class="col-sm-6">
                  ...
                  <input type="text" class="swpm-text-field swpm-username-field" id="swpm_user_name" value="" name="swpm_user_name" />
            </div>
            <div class="col-sm-6">
                  <label for="swpm_password" class="swpm-label"><?php echo SwpmUtils::_('Password') ?></label>
                  <input type="password" class="swpm-text-field swpm-password-field" id="swpm_password" value="" name="swpm_password" />
            </div>
          </div>
