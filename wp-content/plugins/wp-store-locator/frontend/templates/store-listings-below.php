...
$output .= '<h2 id="search-message">Enter your zip code above to search for a Fredrix store near you. </h2>';
...
if ( $this->settings['reset_map'] ) { 
    ...
    $output .= '<div id="sticky-anchor"></div><div id="wpsl-gmap" class="sticky"></div>' . "\r\n";
    $output .= '</div>' . "\r\n";
} else {
    $output .= '<div id="sticky-anchor"></div><div id="wpsl-gmap" class="sticky"></div>' . "\r\n";
}
